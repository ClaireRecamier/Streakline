...
proc main(){
  ...
  var chfile = open("/mathematica/1.csv",iomode.cw); //create test.csv and open
  var SDfile = open("/mathematica/SD1.csv",iomode.cw); //create test.csv and open
  var AMfile = open("/mathematica/AM1.csv",iomode.cw); //create test.csv and open
  var PSfile = open("/mathematica/PS1.csv",iomode.cw); //create test.csv and open
